  ...
  //          c?.MessageArrayAddRange(MessageArray);
   ...
   /*     public Job()
    ...
    //20190609                c.statistic =  Chat_GetMyStatistic((int)chatid);
        ...
        internal bool RegisterComputer(Device d)
        {
      ...
      async  public    Task GetUsers()
        ...
        public  void ConnectToServer()
        {
            if (this_user!=null)
                if (this_device!=null)
                {
                    ConnectToServer(this_device.Name, this_user.userName);
                }
        }
        public void ConnectToServer(string machineName, string userName)
        {
        ...
        public void Close()
        {
            ...
            //if (this_user!=null)
            net.WS_CloseConnect(this_user, this_device);
            b_Connected = false;
