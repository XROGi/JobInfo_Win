...
public enum xFilterAttribute { JobMy, JobFromMy };
namespace Ji.Views
{
    ...
    public partial class JobsViewPage : ContentPage
    {
            ...
            {
                InitializeComponent();
            Init( new List<xFilterAttribute>()  );
             

            }

        public JobsViewPage(List<xFilterAttribute> attrList)
        {
            InitializeComponent();
            Init(attrList);
        ...
        private void Init(List<xFilterAttribute> attrList)
        {
            BindingContext = viewModel = new ItemsViewModel(attrList);
            viewModel.b_ShowJob = true;
        ...
        internal void Switch_HidePanel()
        {
        ...
        private void OnItemAppearing(object sender, ItemVisibilityEventArgs e)
        {
            ...
            try
            {
                if (e.Item != null)
                {
                    ...
                    if (chat != null)
                    {
                 //20200325       viewModel.Request_Chat_Statistic(chat);
        ...
        {
            viewModel.IsFromMySelected = !viewModel.IsFromMySelected;
